...
export default async function SpecialEducationUnitPage() {
  const pageData = await getPage('special-education-unit');
  const acf = (pageData?.acf || {}) as SpecialEducationUnitACF;
