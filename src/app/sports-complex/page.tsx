...
export default async function SportsComplexPage() {
  const pageData = await getPage('sports-complex');
  const acf = (pageData?.acf || {}) as SportsComplexACF;
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-gray-900">
        <div className="absolute inset-0 w-full h-full z-0">
          {acf.cover?.url && (
            <Image
              src={acf.cover.url}
              alt={acf.cover.alt || acf.heading || 'Sports Complex'}
